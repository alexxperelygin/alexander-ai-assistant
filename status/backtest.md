...
NO EDGE: expectancy -4.0% ≤ 0 после издержек. Сигналы в текущем виде не зарабатывают.
{
  "strategy": {
    ...
    "rugRate": 0.07407407407407407,
    "rugMeasurable": 216,
    "unclosablePct": 0.10416666666666667,
    "byMonth": {
      "2026-08": {
        "n": 125,
...
NO EDGE: expectancy -4.3% ≤ 0 после издержек. Сигналы в текущем виде не зарабатывают.
{
  "strategy": {
    ...
    "expectancy": -0.04285125465681671,
    "medianReturn": -0.01808127218318545,
    "profitFactor": 0.5475814392884789,
    "maxDrawdown": 1.0000000003832348,
    "rugRate": 0.04186046511627907,
    "rugMeasurable": 215,
    "unclosablePct": 0.10416666666666667,
    "byMonth": {
      "2026-08": {
      ...
      "2026-09": {
        "n": 1,
        "meanReturn": 0.06406992879536944
      }
    }
  },
  "baseline": {
