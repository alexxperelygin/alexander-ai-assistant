...
NO EDGE: expectancy -4.4% ≤ 0 после издержек. Сигналы в текущем виде не зарабатывают.
{
  "strategy": {
    ...
    "expectancy": -0.0440323898964455,
    "medianReturn": -0.023542928714225475,
    "profitFactor": 0.55999991313061,
    ...
    "byMonth": {
      ...
      "2026-09": {
        "n": 111,
        "meanReturn": -0.04857638787446003
      }
    }
  },
  "baseline": {
...
NO EDGE: expectancy -4.9% ≤ 0 после издержек. Сигналы в текущем виде не зарабатывают.
{
  "strategy": {
    ...
    "horizon": "6h",
    "evaluable": 324,
    "winRate": 0.33024691358024694,
    "expectancy": -0.0494263956628035,
    "medianReturn": -0.016233113744140493,
    "profitFactor": 0.43912614776409764,
    ...
    "byMonth": {
      ...
      "2026-09": {
        "n": 147,
        "meanReturn": -0.056616047190745464
      }
    }
  },
  "baseline": {
